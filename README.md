...
uv run python -m nuitka --standalone --mingw64 --enable-plugin=playwright main.py

uv run python -m nuitka --standalone --mingw64 --include-data-dir=.venv\Lib\site-packages\playwright\driver=playwright\driver main.py

uv run python -m nuitka --standalone --mingw64 --nofollow-import-to=playwright --include-data-dir=.venv\Lib\site-packages\playwright\driver=playwright\driver main.py
